...
import { PlusCircle, Trash2, Calendar, Settings, BookOpen, MessageSquare, Save, Search, Briefcase } from "lucide-react";
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-slate-500">Manage job listings, learning content, and settings.</p>
        </div>
      </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4 text-sm">
              ...
              <div className="pt-2 flex space-x-2">
                <button type="submit" className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 rounded-xl transition-all shadow-sm text-xs">
                  Publish Job
                </button>
              </div>
            </form>
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-4">
              ...
              <form onSubmit={(e) => { e.preventDefault(); triggerNotification("Popup link updated!"); }} className="space-y-3 text-sm">
                ...
                <button type="submit" className="w-full bg-purple-600 hover:bg-purple-700 text-white font-bold py-2.5 rounded-xl transition-all shadow-sm text-xs">
                  Save Popup Link
                </button>
              </form>
            </div>
      ...
      {activeSection === "reels" && (
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm max-w-lg space-y-4">
          ...
          <form onSubmit={handleReelSubmit} className="space-y-3 text-sm">
            ...
            <button type="submit" className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:opacity-90 text-white font-bold py-2.5 rounded-xl transition-all shadow-sm text-xs">
      ...
      {activeSection === "bulk" && (
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm max-w-lg space-y-4">
          ...
          <form onSubmit={(e) => { e.preventDefault(); triggerNotification("Bulk delete executed!"); }} className="space-y-3 text-sm">
            ...
            <button type="submit" className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-2.5 rounded-xl transition-all shadow-sm text-xs">
              Bulk Delete Jobs
            </button>
          </form>
        </div>
