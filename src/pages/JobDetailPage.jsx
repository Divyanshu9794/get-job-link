...
export default function JobDetailPage() {
  ...
  // --- URL FIX ---
  // Ensure the URL has http:// or https:// so the browser knows it's an external link
  let applyUrl = job.url || job.applyUrl || job.link || "";
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      ...
      <article className="bg-white rounded-3xl border border-slate-200 shadow-lg overflow-hidden">
        <div className="p-6 sm:p-8">
          ...
          <div className="mt-8 pt-6 border-t border-slate-100">
            {/* The href here is now updated to use the formatted applyUrl */}
            <a
              href={applyUrl}
              target="_blank"
              rel="noopener noreferrer"
